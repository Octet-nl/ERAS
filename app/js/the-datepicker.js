...
(function (TheDatepicker) {
    ...
    var Options = (function () {
        function Options(translator) {
            ...
            this.dropdownStartYear = 0;
            this.dropdownEndYear = 0;
            this.goBackHtml = '&lt;';
            this.goForwardHtml = '&gt;';
        ...
        Options.prototype.clone = function () {
            ...
            options.dropdownStartYear = this.dropdownStartYear;
            options.dropdownEndYear = this.dropdownEndYear
        ...
        Options.prototype.setDropdownStartYear = function (limit) {
            this.dropdownStartYear = TheDatepicker.Helper.checkNumber('Start year', limit, 1);
        };
        Options.prototype.setDropdownEndYear = function (limit) {
            this.dropdownEndYear = TheDatepicker.Helper.checkNumber('End year', limit, 1);
        };
        ...
        Options.prototype.getDropdownStartYear = function () {
            return this.dropdownStartYear;
        };
        Options.prototype.getDropdownEndYear = function () {
            return this.dropdownEndYear;
        };
...
(function (TheDatepicker) {
    var Template = (function () {
        ...
        Template.prototype.calculateDropdownRange = function (current, min, max) {
            ...
            if ( this.options.getDropdownStartYear() > 0 )
            {
                min = this.options.getDropdownStartYear();
                current = 0;
            }
            if ( this.options.getDropdownEndYear() > 0 )
            {
                max = this.options.getDropdownEndYear();
                current = 0;
            }
            console.log ( "current " + current + ", min " + min + ", max " + max );
            ...
            return {
                // Hier wordt minimum en maximum jaartal teruggegeven.
                from: from,
                to: to
            };
        };
