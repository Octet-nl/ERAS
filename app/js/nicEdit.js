 ...
 * 15-08-2020 Hans de Rijck, Aangepast voor lokale opslag
 * 07-10-2020 HdR Regel 470 initial content align left toegevoegd. Was: <br />
 */
...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : 'res/icons/nicEditorIcons.gif',
 ...
 * Clean Word Paste Mod by Billy Flaherty (www.billyswebdesign.com/) for cgCraft (www.cgcraft.com) */
 ...
 var nicEditorInstance = bkClass.extend({
    ...
    init : function() {
        ...
        if(this.getContent() == "") {
            this.setContent('<div align="left"><br/></div>');
        }
...
var OldnicEditorInstance = bkClass.extend({
	isSelected : false,
...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		// Kleurtjes aangepast, was border: #cccccc, backgroundColor: #efefef
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '100%', border : '1px solid #ccccff', backgroundColor : '#e0efff'}).addClass('panelContain');
...
var nicImageOptions = {
	buttons : {
		'image' : {name : 'Add/Edit Image', type : 'nicImageButton', tags : ['IMG']}
	}
...
//	imageURI : '../images/',
	...
	addPane : function() {
		...
		this.addForm({
			'' : {type : 'title', txt : 'Afbeelding toevoegen/wijzigen'},
			'src' : {type : 'text', txt : 'URL', 'value' : this.ne.options.imageURI, style : {width: '150px'}},
			'width' : {type : 'text', txt : 'Breedte', 'value' : '50', style : {width: '100px'}},
			'unit' : {type : 'select', txt : 'Eenheid', options : { '%': '%', 'px' : 'px', 'em' : 'em'}},
			'alt' : {type : 'text', txt : 'Alt-tekst', style : {width: '100px'}},
			'align' : {type : 'select', txt : 'Uitlijn', options : { none: 'Niet', 'left' : 'Links', 'right' : 'Rechts'}}
		},this.im);
	},
	...
	submit : function(e) {
		...
		width = this.inputs['width'].value.replace(/\D/g,'') + this.inputs['unit'].value;
...
var nicUploadOptions = {
	buttons : {
		'upload' : {name : 'Afbeelding uploaden', type : 'nicUploadButton'}
	}
...
//    nicURI : 'http://localhost/FBI/dev/app/nicUpload.php',
...
var nicXHTML = bkClass.extend({
	...
	noShort : ['style','title','script','textarea','a','div','span'],
