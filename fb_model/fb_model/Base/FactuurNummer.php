...
/**
 * Base class that represents a row from the 'fb_factuur' table.
 *
 *
 *
 * @package    propel.generator.fb_model.fb_model.Base
 */
abstract class FactuurNummer implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\fb_model\\fb_model\\Map\\FactuurNummerTableMap';
    ...
    /**
     * Initializes internal state of fb_model\fb_model\Base\FactuurNummer object.
     */
    ...
    /**
     * Compares this with another <code>FactuurNummer</code> instance.  If
     * <code>obj</code> is an instance of <code>FactuurNummer</code>, delegates to
     * <code>equals(FactuurNummer)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|FactuurNummer The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[FactuurNummerTableMap::COL_ID] = true;
        }
    ...
    public function setInschrijvingId($v)
    {
        ...
        if ($this->inschrijving_id !== $v) {
            ...
            $this->modifiedColumns[FactuurNummerTableMap::COL_INSCHRIJVING_ID] = true;
        }
    ...
    public function setDatumGemaakt($v)
    {
        ...
        if ($this->gemaakt_datum !== null || $dt !== null) {
            if ($this->gemaakt_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gemaakt_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FactuurNummerTableMap::COL_GEMAAKT_DATUM] = true;
            }
    ...
    public function setGemaaktDoor($v)
    {
        ...
        if ($this->gemaakt_door !== $v) {
            $this->gemaakt_door = $v;
            $this->modifiedColumns[FactuurNummerTableMap::COL_GEMAAKT_DOOR] = true;
        }
    ...
    public function setDatumGewijzigd($v)
    {
        ...
        if ($this->gewijzigd_datum !== null || $dt !== null) {
            if ($this->gewijzigd_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gewijzigd_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FactuurNummerTableMap::COL_GEWIJZIGD_DATUM] = true;
            }
        } // if either are not null
    ...
    public function setGewijzigdDoor($v)
    {
        ...
        if ($this->gewijzigd_door !== $v) {
            ...
            $this->modifiedColumns[FactuurNummerTableMap::COL_GEWIJZIGD_DOOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FactuurNummerTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildFactuurNummerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see FactuurNummer::setDeleted()
     * @see FactuurNummer::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFactuurNummerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DATUM)) {
                    $this->setDatumGewijzigd($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DATUM)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FactuurNummerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FactuurNummerTableMap::COL_ID)) {
        ...
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEMAAKT_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_door';
        }
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_datum';
        }
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_door';
        }

        $sql = sprintf(
            'INSERT INTO fb_factuur (%s) VALUES (%s)',
    ...
    {
        $pos = FactuurNummerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['FactuurNummer'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FactuurNummer'][$this->hashCode()] = true;
        $keys = FactuurNummerTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\fb_model\fb_model\FactuurNummer
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\fb_model\fb_model\FactuurNummer The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FactuurNummerTableMap::COL_ID)) {
            $criteria->add(FactuurNummerTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(FactuurNummerTableMap::COL_INSCHRIJVING_ID)) {
        ...
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEMAAKT_DOOR)) {
            $criteria->add(FactuurNummerTableMap::COL_GEMAAKT_DOOR, $this->gemaakt_door);
        }
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DATUM)) {
            $criteria->add(FactuurNummerTableMap::COL_GEWIJZIGD_DATUM, $this->gewijzigd_datum);
        }
        if ($this->isColumnModified(FactuurNummerTableMap::COL_GEWIJZIGD_DOOR)) {
            $criteria->add(FactuurNummerTableMap::COL_GEWIJZIGD_DOOR, $this->gewijzigd_door);
        }
    ...
    {
        $criteria = ChildFactuurNummerQuery::create();
        $criteria->add(FactuurNummerTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \fb_model\fb_model\FactuurNummer (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \fb_model\fb_model\FactuurNummer Clone of current object.
     * @throws PropelException
     */
    ...
    public function getInschrijving(ConnectionInterface $con = null)
    {
        if ($this->aInschrijving === null && ($this->inschrijving_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aInschrijving->addFactuurNummers($this);
             */
        }
    ...
    {
        if (null !== $this->aInschrijving) {
            $this->aInschrijving->removeFactuurNummer($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(FactuurNummerTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildFactuurNummer The current object (for fluent API support)
     */
