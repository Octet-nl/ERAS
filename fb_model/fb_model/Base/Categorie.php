...
/**
 * Base class that represents a row from the 'fb_categorie' table.
 *
 *
 *
...
abstract class Categorie implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\fb_model\\fb_model\\Map\\CategorieTableMap';
    ...
    /**
     * Initializes internal state of fb_model\fb_model\Base\Categorie object.
     */
     ...
     * @return $this|\fb_model\fb_model\Categorie The current object (for fluent API support)
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[CategorieTableMap::COL_CODE] = true;
        }
    ...
    public function setNaam($v)
    {
        ...
        if ($this->naam !== $v) {
            $this->naam = $v;
            $this->modifiedColumns[CategorieTableMap::COL_NAAM] = true;
        }
    ...
    public function setIsActief($v)
    {
        ...
        if ($this->actief !== $v) {
            $this->actief = $v;
            $this->modifiedColumns[CategorieTableMap::COL_ACTIEF] = true;
        }
    ...
    public function setDatumGemaakt($v)
    {
        ...
        if ($this->gemaakt_datum !== null || $dt !== null) {
            if ($this->gemaakt_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gemaakt_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CategorieTableMap::COL_GEMAAKT_DATUM] = true;
            }
    ...
    public function setGemaaktDoor($v)
    {
        ...
        if ($this->gemaakt_door !== $v) {
            $this->gemaakt_door = $v;
            $this->modifiedColumns[CategorieTableMap::COL_GEMAAKT_DOOR] = true;
        }
    ...
    public function setDatumGewijzigd($v)
    {
        ...
        if ($this->gewijzigd_datum !== null || $dt !== null) {
            if ($this->gewijzigd_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gewijzigd_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CategorieTableMap::COL_GEWIJZIGD_DATUM] = true;
            }
        } // if either are not null
    ...
    public function setGewijzigdDoor($v)
    {
        ...
        if ($this->gewijzigd_door !== $v) {
            ...
            $this->modifiedColumns[CategorieTableMap::COL_GEWIJZIGD_DOOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategorieTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategorieTableMap::translateFieldName('Naam', TableMap::TYPE_PHPNAME, $indexType)];
            $this->naam = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategorieTableMap::translateFieldName('IsActief', TableMap::TYPE_PHPNAME, $indexType)];
            $this->actief = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategorieTableMap::translateFieldName('DatumGemaakt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gemaakt_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CategorieTableMap::translateFieldName('GemaaktDoor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gemaakt_door = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CategorieTableMap::translateFieldName('DatumGewijzigd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gewijzigd_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CategorieTableMap::translateFieldName('GewijzigdDoor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = CategorieTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\fb_model\\fb_model\\Categorie'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CategorieTableMap::COL_GEMAAKT_DATUM)) {
                    $this->setDatumGemaakt($highPrecision);
                }
                if (!$this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DATUM)) {
                    $this->setDatumGewijzigd($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DATUM)) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_NAAM)) {
            $modifiedColumns[':p' . $index++]  = 'naam';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_ACTIEF)) {
            $modifiedColumns[':p' . $index++]  = 'actief';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEMAAKT_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_datum';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEMAAKT_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_door';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_datum';
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_door';
        }

        $sql = sprintf(
            'INSERT INTO fb_categorie (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\fb_model\fb_model\Categorie
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\fb_model\fb_model\Categorie The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategorieTableMap::COL_CODE)) {
            $criteria->add(CategorieTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_NAAM)) {
            $criteria->add(CategorieTableMap::COL_NAAM, $this->naam);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_ACTIEF)) {
            $criteria->add(CategorieTableMap::COL_ACTIEF, $this->actief);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEMAAKT_DATUM)) {
            $criteria->add(CategorieTableMap::COL_GEMAAKT_DATUM, $this->gemaakt_datum);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEMAAKT_DOOR)) {
            $criteria->add(CategorieTableMap::COL_GEMAAKT_DOOR, $this->gemaakt_door);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DATUM)) {
            $criteria->add(CategorieTableMap::COL_GEWIJZIGD_DATUM, $this->gewijzigd_datum);
        }
        if ($this->isColumnModified(CategorieTableMap::COL_GEWIJZIGD_DOOR)) {
            $criteria->add(CategorieTableMap::COL_GEWIJZIGD_DOOR, $this->gewijzigd_door);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \fb_model\fb_model\Categorie (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \fb_model\fb_model\Categorie Clone of current object.
     * @throws PropelException
     */
