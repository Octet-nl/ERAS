...
/**
 * Base class that represents a row from the 'fb_keuzes' table.
 *
 *
 *
 * @package    propel.generator.fb_model.fb_model.Base
 */
abstract class Keuzes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\fb_model\\fb_model\\Map\\KeuzesTableMap';
    ...
    /**
     * The value for the keuzetype field.
     *
     * @var        int
     */
    protected $keuzetype;
    ...
    /**
     * @var        ObjectCollection|ChildEvenement[] Collection to store aggregation of ChildEvenement objects.
     */
     ...
     * @var ObjectCollection|ChildEvenement[]
     */
    protected $evenementsScheduledForDeletion = null;
    ...
    /**
     * Initializes internal state of fb_model\fb_model\Base\Keuzes object.
     */
    ...
    /**
     * Compares this with another <code>Keuzes</code> instance.  If
     * <code>obj</code> is an instance of <code>Keuzes</code>, delegates to
     * <code>equals(Keuzes)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [keuzetype] column value.
     *
     * @return int
     */
    public function getKeuzeType()
    {
        return $this->keuzetype;
    }
     ...
     * @return $this|\fb_model\fb_model\Keuzes The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_ID] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_CODE] = true;
        }
    ...
    /**
     * Set the value of [keuzetype] column.
     *
     * @param int $v New value
     * @return $this|\fb_model\fb_model\Keuzes The current object (for fluent API support)
     */
    public function setKeuzeType($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->keuzetype !== $v) {
            $this->keuzetype = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_KEUZETYPE] = true;
        }
    ...
    public function setNaam($v)
    {
        ...
        if ($this->naam !== $v) {
            $this->naam = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_NAAM] = true;
        }
    ...
    public function setIsActief($v)
    {
        ...
        if ($this->actief !== $v) {
            $this->actief = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_ACTIEF] = true;
        }
    ...
    public function setDatumGemaakt($v)
    {
        ...
        if ($this->gemaakt_datum !== null || $dt !== null) {
            if ($this->gemaakt_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gemaakt_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[KeuzesTableMap::COL_GEMAAKT_DATUM] = true;
            }
    ...
    public function setGemaaktDoor($v)
    {
        ...
        if ($this->gemaakt_door !== $v) {
            $this->gemaakt_door = $v;
            $this->modifiedColumns[KeuzesTableMap::COL_GEMAAKT_DOOR] = true;
        }
    ...
    public function setDatumGewijzigd($v)
    {
        ...
        if ($this->gewijzigd_datum !== null || $dt !== null) {
            if ($this->gewijzigd_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gewijzigd_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[KeuzesTableMap::COL_GEWIJZIGD_DATUM] = true;
            }
        } // if either are not null
    ...
    public function setGewijzigdDoor($v)
    {
        ...
        if ($this->gewijzigd_door !== $v) {
            ...
            $this->modifiedColumns[KeuzesTableMap::COL_GEWIJZIGD_DOOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : KeuzesTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : KeuzesTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : KeuzesTableMap::translateFieldName('KeuzeType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->keuzetype = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : KeuzesTableMap::translateFieldName('Naam', TableMap::TYPE_PHPNAME, $indexType)];
            $this->naam = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : KeuzesTableMap::translateFieldName('IsActief', TableMap::TYPE_PHPNAME, $indexType)];
            $this->actief = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : KeuzesTableMap::translateFieldName('DatumGemaakt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gemaakt_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : KeuzesTableMap::translateFieldName('GemaaktDoor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gemaakt_door = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : KeuzesTableMap::translateFieldName('DatumGewijzigd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gewijzigd_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : KeuzesTableMap::translateFieldName('GewijzigdDoor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = KeuzesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\fb_model\\fb_model\\Keuzes'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildKeuzesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Keuzes::setDeleted()
     * @see Keuzes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildKeuzesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(KeuzesTableMap::COL_GEMAAKT_DATUM)) {
                    $this->setDatumGemaakt($highPrecision);
                }
                if (!$this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DATUM)) {
                    $this->setDatumGewijzigd($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DATUM)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                KeuzesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->evenementsScheduledForDeletion !== null) {
                if (!$this->evenementsScheduledForDeletion->isEmpty()) {
                    \fb_model\fb_model\EvenementQuery::create()
                        ->filterByPrimaryKeys($this->evenementsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->evenementsScheduledForDeletion = null;
                }
            }

            if ($this->collEvenements !== null) {
                foreach ($this->collEvenements as $referrerFK) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(KeuzesTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_KEUZETYPE)) {
            $modifiedColumns[':p' . $index++]  = 'keuzetype';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_NAAM)) {
            $modifiedColumns[':p' . $index++]  = 'naam';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_ACTIEF)) {
            $modifiedColumns[':p' . $index++]  = 'actief';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEMAAKT_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_datum';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEMAAKT_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_door';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_datum';
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_door';
        }

        $sql = sprintf(
            'INSERT INTO fb_keuzes (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'code':
                        ...
                        break;
                    case 'keuzetype':
                        $stmt->bindValue($identifier, $this->keuzetype, PDO::PARAM_INT);
                        break;
                    case 'naam':
    ...
    {
        $pos = KeuzesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Keuzes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Keuzes'][$this->hashCode()] = true;
        $keys = KeuzesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getKeuzeType(),
            $keys[3] => $this->getNaam(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collEvenements) {
                ...
                $result[$key] = $this->collEvenements->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\fb_model\fb_model\Keuzes
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setKeuzeType($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNaam($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\fb_model\fb_model\Keuzes The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KeuzesTableMap::COL_ID)) {
            $criteria->add(KeuzesTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_CODE)) {
            $criteria->add(KeuzesTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_KEUZETYPE)) {
            $criteria->add(KeuzesTableMap::COL_KEUZETYPE, $this->keuzetype);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_NAAM)) {
            $criteria->add(KeuzesTableMap::COL_NAAM, $this->naam);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_ACTIEF)) {
            $criteria->add(KeuzesTableMap::COL_ACTIEF, $this->actief);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEMAAKT_DATUM)) {
            $criteria->add(KeuzesTableMap::COL_GEMAAKT_DATUM, $this->gemaakt_datum);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEMAAKT_DOOR)) {
            $criteria->add(KeuzesTableMap::COL_GEMAAKT_DOOR, $this->gemaakt_door);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DATUM)) {
            $criteria->add(KeuzesTableMap::COL_GEWIJZIGD_DATUM, $this->gewijzigd_datum);
        }
        if ($this->isColumnModified(KeuzesTableMap::COL_GEWIJZIGD_DOOR)) {
            $criteria->add(KeuzesTableMap::COL_GEWIJZIGD_DOOR, $this->gewijzigd_door);
        }
    ...
    {
        $criteria = ChildKeuzesQuery::create();
        $criteria->add(KeuzesTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \fb_model\fb_model\Keuzes (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setKeuzeType($this->getKeuzeType());
        ...
        if ($deepCopy) {
            ...
            foreach ($this->getEvenements() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addEvenement($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \fb_model\fb_model\Keuzes Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Clears out the collEvenements collection
     *
     ...
     * @see        addEvenements()
     */
    public function clearEvenements()
    {
        $this->collEvenements = null; // important to set this to NULL since that means it is uninitialized
    }

    /**
     * Reset is the collEvenements collection loaded partially.
     */
    public function resetPartialEvenements($v = true)
    {
        $this->collEvenementsPartial = $v;
    }

    /**
     * Initializes the collEvenements collection.
     *
     * By default this just sets the collEvenements collection to an empty array (like clearcollEvenements());
     ...
     * @return void
     */
    public function initEvenements($overrideExisting = true)
    {
        if (null !== $this->collEvenements && !$overrideExisting) {
            return;
        }

        $collectionClassName = EvenementTableMap::getTableMap()->getCollectionClassName();

        $this->collEvenements = new $collectionClassName;
        $this->collEvenements->setModel('\fb_model\fb_model\Evenement');
    }

    /**
     * Gets an array of ChildEvenement objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this ChildKeuzes is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildEvenement[] List of ChildEvenement objects
     * @throws PropelException
     */
    public function getEvenements(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        $partial = $this->collEvenementsPartial && !$this->isNew();
        if (null === $this->collEvenements || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEvenements) {
                    ...
                    $collEvenements = new $collectionClassName;
                    $collEvenements->setModel('\fb_model\fb_model\Evenement');

                    return $collEvenements;
                }
            } else {
                $collEvenements = ChildEvenementQuery::create(null, $criteria)
                    ->filterByKeuzes($this)
                    ->find($con);

                if (null !== $criteria) {
                    if (false !== $this->collEvenementsPartial && count($collEvenements)) {
                        $this->initEvenements(false);

                        foreach ($collEvenements as $obj) {
                            if (false == $this->collEvenements->contains($obj)) {
                                $this->collEvenements->append($obj);
                            }
                        }

                        $this->collEvenementsPartial = true;
                    }

                    return $collEvenements;
                }

                if ($partial && $this->collEvenements) {
                    foreach ($this->collEvenements as $obj) {
                        if ($obj->isNew()) {
                            $collEvenements[] = $obj;
                        }
                    }
                ...
                $this->collEvenements = $collEvenements;
                $this->collEvenementsPartial = false;
            }
        }

        return $this->collEvenements;
    }

    /**
     * Sets a collection of ChildEvenement objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param      Collection $evenements A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildKeuzes The current object (for fluent API support)
     */
    public function setEvenements(Collection $evenements, ConnectionInterface $con = null)
    {
        /** @var ChildEvenement[] $evenementsToDelete */
        $evenementsToDelete = $this->getEvenements(new Criteria(), $con)->diff($evenements);


        $this->evenementsScheduledForDeletion = $evenementsToDelete;

        foreach ($evenementsToDelete as $evenementRemoved) {
            $evenementRemoved->setKeuzes(null);
        }
        ...
        $this->collEvenements = $evenements;
        $this->collEvenementsPartial = false;
    ...
    /**
     * Returns the number of related Evenement objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related Evenement objects.
     * @throws PropelException
     */
    public function countEvenements(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collEvenementsPartial && !$this->isNew();
        if (null === $this->collEvenements || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collEvenements) {
                return 0;
            }

            if ($partial && !$criteria) {
                return count($this->getEvenements());
            }

            $query = ChildEvenementQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collEvenements);
    }

    /**
     * Method called to associate a ChildEvenement object to this object
     * through the ChildEvenement foreign key attribute.
     *
     * @param  ChildEvenement $l ChildEvenement
     * @return $this|\fb_model\fb_model\Keuzes The current object (for fluent API support)
     */
    public function addEvenement(ChildEvenement $l)
    {
        if ($this->collEvenements === null) {
            $this->initEvenements();
            $this->collEvenementsPartial = true;
        ...
        if (!$this->collEvenements->contains($l)) {
            $this->doAddEvenement($l);

            if ($this->evenementsScheduledForDeletion and $this->evenementsScheduledForDeletion->contains($l)) {
                $this->evenementsScheduledForDeletion->remove($this->evenementsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param ChildEvenement $evenement The ChildEvenement object to add.
     */
    protected function doAddEvenement(ChildEvenement $evenement)
    {
        $this->collEvenements[]= $evenement;
        $evenement->setKeuzes($this);
    }

    /**
     * @param  ChildEvenement $evenement The ChildEvenement object to remove.
     * @return $this|ChildKeuzes The current object (for fluent API support)
     */
    public function removeEvenement(ChildEvenement $evenement)
    {
        if ($this->getEvenements()->contains($evenement)) {
            $pos = $this->collEvenements->search($evenement);
            $this->collEvenements->remove($pos);
            if (null === $this->evenementsScheduledForDeletion) {
                $this->evenementsScheduledForDeletion = clone $this->collEvenements;
                $this->evenementsScheduledForDeletion->clear();
            }
            $this->evenementsScheduledForDeletion[]= clone $evenement;
            $evenement->setKeuzes(null);
        }
    ...
    public function setGebruikers(Collection $gebruikers, ConnectionInterface $con = null)
    {
        ...
        foreach ($gebruikersToDelete as $gebruikerRemoved) {
            $gebruikerRemoved->setKeuzes(null);
        }
     ...
     * Otherwise if this Keuzes is new, it will return
     * an empty collection; or if this Keuzes has previously
     * been saved, it will retrieve related Gebruikers from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Keuzes.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildGebruiker[] List of ChildGebruiker objects
     */
    public function getGebruikersJoinPersoon(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGebruikerQuery::create(null, $criteria);
    ...
    public function setInschrijvings(Collection $inschrijvings, ConnectionInterface $con = null)
    {
        ...
        foreach ($inschrijvingsToDelete as $inschrijvingRemoved) {
            $inschrijvingRemoved->setKeuzes(null);
        }
    ...
    {
        if ($deep) {
            if ($this->collEvenements) {
                foreach ($this->collEvenements as $o) {
    ...
    {
        return (string) $this->exportTo(KeuzesTableMap::DEFAULT_STRING_FORMAT);
    }
