...
/**
 * Base class that represents a row from the 'fb_evenement_heeft_optie' table.
 *
 *
 *
 * @package    propel.generator.fb_model.fb_model.Base
 */
abstract class EvenementHeeftOptie implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\fb_model\\fb_model\\Map\\EvenementHeeftOptieTableMap';
    ...
    /**
     * Initializes internal state of fb_model\fb_model\Base\EvenementHeeftOptie object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EvenementHeeftOptie</code> instance.  If
     * <code>obj</code> is an instance of <code>EvenementHeeftOptie</code>, delegates to
     * <code>equals(EvenementHeeftOptie)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EvenementHeeftOptie The current object, for fluid interface
     */
     ...
     * @return $this|\fb_model\fb_model\EvenementHeeftOptie The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_ID] = true;
        }
    ...
    public function setEvenementId($v)
    {
        ...
        if ($this->evenement_id !== $v) {
            $this->evenement_id = $v;
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_EVENEMENT_ID] = true;
        }
    ...
    public function setOptieId($v)
    {
        ...
        if ($this->optie_id !== $v) {
            $this->optie_id = $v;
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_OPTIE_ID] = true;
        }
    ...
    public function setVolgorde($v)
    {
        ...
        if ($this->volgorde !== $v) {
            $this->volgorde = $v;
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_VOLGORDE] = true;
        }
    ...
    public function setDatumGemaakt($v)
    {
        ...
        if ($this->gemaakt_datum !== null || $dt !== null) {
            if ($this->gemaakt_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gemaakt_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_GEMAAKT_DATUM] = true;
            }
    ...
    public function setGemaaktDoor($v)
    {
        ...
        if ($this->gemaakt_door !== $v) {
            $this->gemaakt_door = $v;
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_GEMAAKT_DOOR] = true;
        }
    ...
    public function setDatumGewijzigd($v)
    {
        ...
        if ($this->gewijzigd_datum !== null || $dt !== null) {
            if ($this->gewijzigd_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gewijzigd_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM] = true;
            }
        } // if either are not null
    ...
    public function setGewijzigdDoor($v)
    {
        ...
        if ($this->gewijzigd_door !== $v) {
            ...
            $this->modifiedColumns[EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DOOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('EvenementId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->evenement_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('OptieId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->optie_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('Volgorde', TableMap::TYPE_PHPNAME, $indexType)];
            $this->volgorde = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('DatumGemaakt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gemaakt_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('GemaaktDoor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gemaakt_door = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('DatumGewijzigd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gewijzigd_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EvenementHeeftOptieTableMap::translateFieldName('GewijzigdDoor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = EvenementHeeftOptieTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\fb_model\\fb_model\\EvenementHeeftOptie'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEvenementHeeftOptieQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EvenementHeeftOptie::setDeleted()
     * @see EvenementHeeftOptie::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEvenementHeeftOptieQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEMAAKT_DATUM)) {
                    $this->setDatumGemaakt($highPrecision);
                }
                if (!$this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM)) {
                    $this->setDatumGewijzigd($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EvenementHeeftOptieTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_EVENEMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'evenement_id';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_OPTIE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'optie_id';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_VOLGORDE)) {
            $modifiedColumns[':p' . $index++]  = 'volgorde';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEMAAKT_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_datum';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEMAAKT_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_door';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_datum';
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_door';
        }

        $sql = sprintf(
            'INSERT INTO fb_evenement_heeft_optie (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'optie_id':
                        ...
                        break;
                    case 'volgorde':
                        $stmt->bindValue($identifier, $this->volgorde, PDO::PARAM_INT);
                        break;
                    case 'gemaakt_datum':
    ...
    {
        $pos = EvenementHeeftOptieTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EvenementHeeftOptie'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EvenementHeeftOptie'][$this->hashCode()] = true;
        $keys = EvenementHeeftOptieTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getEvenementId(),
            $keys[2] => $this->getOptieId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\fb_model\fb_model\EvenementHeeftOptie
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setOptieId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setVolgorde($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\fb_model\fb_model\EvenementHeeftOptie The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_ID)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_EVENEMENT_ID)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_EVENEMENT_ID, $this->evenement_id);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_OPTIE_ID)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_OPTIE_ID, $this->optie_id);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_VOLGORDE)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_VOLGORDE, $this->volgorde);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEMAAKT_DATUM)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_GEMAAKT_DATUM, $this->gemaakt_datum);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEMAAKT_DOOR)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_GEMAAKT_DOOR, $this->gemaakt_door);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DATUM, $this->gewijzigd_datum);
        }
        if ($this->isColumnModified(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DOOR)) {
            $criteria->add(EvenementHeeftOptieTableMap::COL_GEWIJZIGD_DOOR, $this->gewijzigd_door);
        }
    ...
    {
        $criteria = ChildEvenementHeeftOptieQuery::create();
        $criteria->add(EvenementHeeftOptieTableMap::COL_ID, $this->id);
        $criteria->add(EvenementHeeftOptieTableMap::COL_EVENEMENT_ID, $this->evenement_id);
        $criteria->add(EvenementHeeftOptieTableMap::COL_OPTIE_ID, $this->optie_id);
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getId() &&
            null !== $this->getEvenementId() &&
            null !== $this->getOptieId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation fb_evenement_heeft_optie_fk_d45e30 to table fb_evenement
        if ($this->aEvenement && $hash = spl_object_hash($this->aEvenement)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }

        //relation fb_evenement_heeft_optie_fk_c81db2 to table fb_optie
    ...
    public function getPrimaryKey()
    {
        $pks = array();
        $pks[0] = $this->getId();
        $pks[1] = $this->getEvenementId();
        $pks[2] = $this->getOptieId();
    ...
    {
        $this->setId($keys[0]);
        $this->setEvenementId($keys[1]);
        $this->setOptieId($keys[2]);
    }
    ...
    {
        return (null === $this->getId()) && (null === $this->getEvenementId()) && (null === $this->getOptieId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \fb_model\fb_model\EvenementHeeftOptie (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setVolgorde($this->getVolgorde());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \fb_model\fb_model\EvenementHeeftOptie Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEvenement(ConnectionInterface $con = null)
    {
        if ($this->aEvenement === null && ($this->evenement_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvenement->addEvenementHeeftOpties($this);
             */
        }
    ...
    public function getOptie(ConnectionInterface $con = null)
    {
        if ($this->aOptie === null && ($this->optie_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOptie->addEvenementHeeftOpties($this);
             */
        }
    ...
    {
        if (null !== $this->aEvenement) {
            $this->aEvenement->removeEvenementHeeftOptie($this);
        }
        if (null !== $this->aOptie) {
            $this->aOptie->removeEvenementHeeftOptie($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(EvenementHeeftOptieTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildEvenementHeeftOptie The current object (for fluent API support)
     */
