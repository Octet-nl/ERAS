...
/**
 * Base class that represents a row from the 'fb_contactlog' table.
 *
 *
 *
 * @package    propel.generator.fb_model.fb_model.Base
 */
abstract class Contactlog implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\fb_model\\fb_model\\Map\\ContactlogTableMap';
    ...
    /**
     * Initializes internal state of fb_model\fb_model\Base\Contactlog object.
     */
    ...
    /**
     * Compares this with another <code>Contactlog</code> instance.  If
     * <code>obj</code> is an instance of <code>Contactlog</code>, delegates to
     * <code>equals(Contactlog)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ContactlogTableMap::COL_ID] = true;
        }
    ...
    public function setPersoonId($v)
    {
        ...
        if ($this->persoon_id !== $v) {
            $this->persoon_id = $v;
            $this->modifiedColumns[ContactlogTableMap::COL_PERSOON_ID] = true;
        }
    ...
    public function setTekst($v)
    {
        ...
        if ($this->tekst !== $v) {
            $this->tekst = $v;
            $this->modifiedColumns[ContactlogTableMap::COL_TEKST] = true;
        }
    ...
    public function setDatumGemaakt($v)
    {
        ...
        if ($this->gemaakt_datum !== null || $dt !== null) {
            if ($this->gemaakt_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gemaakt_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ContactlogTableMap::COL_GEMAAKT_DATUM] = true;
            }
    ...
    public function setGemaaktDoor($v)
    {
        ...
        if ($this->gemaakt_door !== $v) {
            $this->gemaakt_door = $v;
            $this->modifiedColumns[ContactlogTableMap::COL_GEMAAKT_DOOR] = true;
        }
    ...
    public function setDatumGewijzigd($v)
    {
        ...
        if ($this->gewijzigd_datum !== null || $dt !== null) {
            if ($this->gewijzigd_datum === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->gewijzigd_datum->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ContactlogTableMap::COL_GEWIJZIGD_DATUM] = true;
            }
        } // if either are not null
    ...
    public function setGewijzigdDoor($v)
    {
        ...
        if ($this->gewijzigd_door !== $v) {
            ...
            $this->modifiedColumns[ContactlogTableMap::COL_GEWIJZIGD_DOOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ContactlogTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ContactlogTableMap::translateFieldName('PersoonId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->persoon_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ContactlogTableMap::translateFieldName('Tekst', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tekst = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ContactlogTableMap::translateFieldName('DatumGemaakt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gemaakt_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ContactlogTableMap::translateFieldName('GemaaktDoor', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gemaakt_door = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ContactlogTableMap::translateFieldName('DatumGewijzigd', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->gewijzigd_datum = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ContactlogTableMap::translateFieldName('GewijzigdDoor', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = ContactlogTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\fb_model\\fb_model\\Contactlog'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildContactlogQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Contactlog::setDeleted()
     * @see Contactlog::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildContactlogQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ContactlogTableMap::COL_GEMAAKT_DATUM)) {
                    $this->setDatumGemaakt($highPrecision);
                }
                if (!$this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DATUM)) {
                    $this->setDatumGewijzigd($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DATUM)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ContactlogTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ContactlogTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ContactlogTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ContactlogTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_PERSOON_ID)) {
            $modifiedColumns[':p' . $index++]  = 'persoon_id';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_TEKST)) {
            $modifiedColumns[':p' . $index++]  = 'tekst';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEMAAKT_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_datum';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEMAAKT_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gemaakt_door';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DATUM)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_datum';
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DOOR)) {
            $modifiedColumns[':p' . $index++]  = 'gewijzigd_door';
        }

        $sql = sprintf(
            'INSERT INTO fb_contactlog (%s) VALUES (%s)',
    ...
    {
        $pos = ContactlogTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Contactlog'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Contactlog'][$this->hashCode()] = true;
        $keys = ContactlogTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPersoonId(),
            $keys[2] => $this->getTekst(),
            $keys[3] => $this->getDatumGemaakt(),
            $keys[4] => $this->getGemaaktDoor(),
            $keys[5] => $this->getDatumGewijzigd(),
            $keys[6] => $this->getGewijzigdDoor(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\fb_model\fb_model\Contactlog
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setTekst($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setDatumGemaakt($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setGemaaktDoor($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setDatumGewijzigd($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setGewijzigdDoor($arr[$keys[6]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\fb_model\fb_model\Contactlog The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ContactlogTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ContactlogTableMap::COL_ID)) {
            $criteria->add(ContactlogTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_PERSOON_ID)) {
            $criteria->add(ContactlogTableMap::COL_PERSOON_ID, $this->persoon_id);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_TEKST)) {
            $criteria->add(ContactlogTableMap::COL_TEKST, $this->tekst);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEMAAKT_DATUM)) {
            $criteria->add(ContactlogTableMap::COL_GEMAAKT_DATUM, $this->gemaakt_datum);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEMAAKT_DOOR)) {
            $criteria->add(ContactlogTableMap::COL_GEMAAKT_DOOR, $this->gemaakt_door);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DATUM)) {
            $criteria->add(ContactlogTableMap::COL_GEWIJZIGD_DATUM, $this->gewijzigd_datum);
        }
        if ($this->isColumnModified(ContactlogTableMap::COL_GEWIJZIGD_DOOR)) {
            $criteria->add(ContactlogTableMap::COL_GEWIJZIGD_DOOR, $this->gewijzigd_door);
        }
    ...
    {
        $criteria = ChildContactlogQuery::create();
        $criteria->add(ContactlogTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \fb_model\fb_model\Contactlog (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \fb_model\fb_model\Contactlog Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPersoon(ConnectionInterface $con = null)
    {
        if ($this->aPersoon === null && ($this->persoon_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPersoon->addContactlogs($this);
             */
        }
    ...
    {
        if (null !== $this->aPersoon) {
            $this->aPersoon->removeContactlog($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ContactlogTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     $this|ChildContactlog The current object (for fluent API support)
     */
